...
const RecentDetail = () => {
  ...
  const post = blogsData.slice(1,3).find((post) => post.id === newId);
  ...
  return (
    <section className='mx-[7%] w-[86%] sm:mx-[5%] sm:w-[90%] mb-[60px]'>
       <h1 
         className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-800 mt-[60px]" 
         data-aos="fade-up">
         {post.topic}
       </h1>
      ...
      <p className='text-lg font-semibold mt-3 text-gray-700' data-aos="fade-up">
        {post?.section7}
      </p>
      <div className='mt-12'>
