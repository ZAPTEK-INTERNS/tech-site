  ...
  return (
    <><div className="md:flex my-20 ">
          <div className="md:w-2/5 border border-slate-400   flex justify-center item-center">
            <div className="py-12 hover:text-purple-900 font-medium">
               <Link href={`/case-studies/${prevItem.id}`}>{prevItem.title }</Link> 
                </div>
          </div>
          ...
          <div className="md:w-2/5 border border-slate-400  flex justify-center item-center">
          <div className="py-12 hover:text-purple-900 font-medium">
          <Link href={`/case-studies/${nextItem.id}`}>{nextItem.title }</Link>
                </div>
          </div>
      </div>
</>
