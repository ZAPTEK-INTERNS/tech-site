  ...
  return (
    <div className='my-20 space-y-8 md:space-y-0 lg:flex md:space-x-12'>
      <div className='space-y-6 lg:w-1/2 md:py-12 justify-between'>
        ...
        <h3 data-aos="fade-up" className='font-medium text-[#1a0533] md:pr-4  text-center md:mx-16'>Explore the transformative journey as Tech collaboratively empowers clients to achieve their digital innovation goals.</h3>
      </div>
