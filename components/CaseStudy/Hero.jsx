  ...
  return (
    <div className='my-20 space-y-8 md:space-y-0 md:flex'>
      <div className='space-y-6 md:w-1/2 md:py-12'>
        ...
        <h3 className='font-medium text-[#1a0533] md:pr-4'>Explore the transformative journey as Tech collaboratively empowers clients to achieve their digital innovation goals.</h3>
      </div>
