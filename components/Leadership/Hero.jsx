...
const Hero = () => {
  return (
    <section className='bg-ourteam bg-cover bg-center bg-no-repeat w-full h-screen'>
     <header className='grid grid-cols-5 gap-8 my-[50px] mx-[5%] w-[90%] lg:w-[90%] lg:ml-[7%] mr-0 lg:mr-[3%] h-fit mb-[130px] place-items-center'>
      ...
      <div className='col-span-5 md:col-span-3 w-full flex flex-col justify-center items-center md:justify-right md:items-right md:relative'>
