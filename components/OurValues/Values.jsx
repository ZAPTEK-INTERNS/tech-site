...
const Values = () => {
  return (
    <div className="md:mx-16 mx-2">
        <h2 className="text-5xl font-bold my-12">Our Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 ">
        <div className="bg-slate-200/30 border border-slate-400  rounded-md p-8 w-fit   space-y-8"  >
      ...
      <div className="bg-purple-900 rounded-md p-8 w-fit  text-white  space-y-8">
