  ...
  return (
    <section className='bg-about bg-fixed bg-cover bg-center bg-no-repeat w-full h-fit pb-6 md:h-screen sm:h-[80vh] lg:h-[100vh]'>
      ...
      <div className='mt-[70px] sm:mt-[120px]'>
        <h1 className='text-5xl sm:text-6xl lg:text-[6rem] font-bold' data-aos="fade-up">
      ...
      <div className='h-[60vh] sm:h-[30vh] md:h-[80vh] grid grid-cols-2 w-full md:w-[26rem]'>
        <div className='bg-purple-100 col-span-2 sm:col-span-1 md:col-span-2' data-aos="fade-down " aos-duration="1000"></div>
        <div className='bg-purple-200 col-span-2 sm:col-span-1 md:col-span-2' data-aos="fade-down" aos-duration="1000"></div>
        <div className='bg-purple-400 col-span-2 sm:col-span-1 md:col-span-2' data-aos="fade-down" aos-duration="1000"></div>
        <div className='bg-purple-500 col-span-2 sm:col-span-1 md:col-span-2' data-aos="fade-down" aos-duration="1000"></div>
        <div className='bg-purple-600 col-span-2 sm:col-span-1 md:col-span-2' data-aos="fade-down" aos-duration="1000"></div>
        <Link 
         href="/getaquote"  data-aos="fade-down" aos-duration="1000"
