...
const Git = () => {
  return (
    <section className='bg-about bg-fixed bg-cover bg-center bg-no-repeat w-full h-screen sm:h-[80vh] lg:h-[100vh]'>
      ...
      <div className='mt-[70px] sm:mt-[120px]'>
        <h1 className='text-5xl sm:text-6xl lg:text-[6rem] font-bold'>Let's build something different</h1>
