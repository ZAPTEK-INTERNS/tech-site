...
const AboutSection = () => {
  return (
    <section className='mx-[5%] w-[90%] lg:w-[80%] lg:mx-[10%] mt-[150px] mb-[100px]'>
     ...
     <div className='grid grid-cols-7 gap-12 text-lg font-semibold '>
       <p className='col-span-7 md:col-span-5 text-gray-500 text-lg font-semibold' data-aos="fade-up">
      ...
      <div className='col-span-7 md:col-span-2' data-aos="fade-left">          
     ...
     <div className='grid grid-cols-7 gap-12 mt-12'>
      <Image 
       src={pricing2} 
       alt="about image" 
       className='col-span-7 md:col-span-5 w-full h-[24rem] rounded-md' 
       data-aos="fade-up"
       />
