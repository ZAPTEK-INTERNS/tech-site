  ...
  return (
    <section className='mt-[150px] mb-[100px] relative'>
      ...
      <div className='text-center flex justify-center items-center flex-col mb-12'>
       ...
       <h1 className='text-4xl sm:text-5xl font-bold my-6'>How we help you</h1>
      </div>
      <div className='grid grid-cols-6 gap-6 z-20'>
       {services.map((service) => (
         <article key={service.id} className='col-span-6 sm:col-span-3 lg:col-span-2 bg-violet-300/10 rounded-md border border-gray-300 relative h-[22rem]'>
