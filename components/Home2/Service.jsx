...
const Service = () => {
  return (
    <div>
       <div className='bg-white bg-cover bg-center bg-no-repeat w-full h-fit sm:h-[50vh] md:h-screen bg-fixed pb-6'>
       <div className='bg-ourteam w-full h-fit sm:h-[50vh] md:h-screen bg-fixed pb-6'>
         ...
         <h1 data-aos="fade-up"
          ...
          <span className='text-violet-500/60'>We are committed to staying at </span> 
          the forefront of technological innovation, {" "}
          <span className='text-violet-500/60'>constantly exploring emerging trends and incorporating the</span>
