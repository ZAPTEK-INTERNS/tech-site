  ...
  return (
    <>
        ...
        <div  className="lg:flex py-16 font-serif bg-white px-16">
          ...
          >
            <h2 data-aos="fade-up" className="text-sm text-purple-900 font-bold py-4">When you choose Tech, you're choosing</h2>
            <p data-aos="fade-up" className="lg:text-7xl text-4xl font-medium mb-4 ">
