...
const GetInTouchGradient = () => {
  return (
    <div > 
      ...
      <div className="bg-purple-100  h-[16.66%]">
      </div>
      <div className="bg-purple-200  h-[16.66%]">
      </div>
      <div className="bg-purple-300  h-[16.66%]">
      </div>
      <div className="bg-purple-500  h-[16.66%]">
      </div>
      <div className="bg-purple-700  h-[16.66%]">
      </div>
      <div className="bg-purple-800  h-[16.66%]">
      </div>
      <div className="bg-purple-900  h-[16.66%]">
