...
const Benefits = () => {
  return (
    <section className='mx-[5%] w-[90%] lg:w-[80%] lg:mx-[10%] my-[100px]'>
      <h1 className='text-4xl sm:text-5xl text-center text-black/80 font-bold mb-12 '>
        Benefits of <br className='hidden md:block'/> working at Tech
     </h1>
      <div className='grid grid-cols-6 mt-6 gap-10'>
        <article className='border border-violet-400/30 rounded-md p-6 bg-violet-100/50 w-full col-span-6 sm:col-span-3 lg:col-span-2'>
        ...
        <article className='border border-violet-400/30 rounded-md p-6 text-white bg-[#1a0533] col-span-6 sm:col-span-3 lg:col-span-2  w-full '>
        ...
        <article className='border border-violet-400/30 rounded-md p-6 bg-violet-100/50 col-span-6 sm:col-span-4 lg:col-span-2  w-full'>
