  ...
  return (
    <section className='mt-[100px] relative'>
       ...
       <div className='absolute top-[30%] text-white mx-[5%] w-[90%] lg:w-[80%] lg:mx-[10%] flex flex-col justify-center items-center text-center'>
        ...
        <p className='my-6 font-semibold text-lg'>Take the first step towards a brighter future and supercharge your business with cutting-edge technologies, expert guidance, and unparalleled support.</p>
