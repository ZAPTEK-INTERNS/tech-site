...
const DropDownA = () => {
  return (
    <div className='bg-white w-fit dropdown absolute hidden group-hover:flex py-3 px-8 rounded-md flex-col gap-4 z-20 text-black/70'>
      <Link href="/" className='hover:text-violet-900'>Home</Link>
