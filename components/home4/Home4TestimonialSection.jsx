  ...
  return (
    ...
    <section className='py-16 md:py-[100px] space-y-12'>
      ...
      <center className='space-y-5 px-4 md:px-[170px] '>
        <h2 className='text-4xl md:text-5xl font-bold text-[#180030] tracking-tighter' data-aos="fade-up">Trusted by more than 1000+ company&apos;s <br className="hidden md:block" /> around the world</h2>
        <p className='text-lg text-[#7987a1]' data-aos="fade-up">
