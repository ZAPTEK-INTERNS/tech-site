  ...
  return (
    <footer className="bg-[#1a0533] text-white ">
         ...
         <div className="flex flex-col gap-4 col-span-5 lg:col-span-2">
           <Image src={logo}/>
            <Link href="https://maps.app.goo.gl/RCrJo5UKJNLZb1Tq7">
             4517 Washington Ave. <br className='hidden lg:block'/>Manchester, Kentucky 39495
            </Link>
            <Link href="mailto:example.com" className="underline">tech@example.com</Link>
            <div className="flex gap-6 mt-3">
              <FaFacebookF className="hover:text-violet-900 transition-all" size={23}/>
              <FaInstagram className="hover:text-violet-900 transition-all" size={23}/>
              <FaXTwitter className="hover:text-violet-900 transition-all" size={23}/>
            </div>
         </div>
      ...
      <div className='flex flex-col md:flex-row gap-4 items-center justify-between py-6  mx-[3%] w-[94%] lg:w-[90%] lg:mx-[5%]'>
       <p>©Tech. All Rights Reserved 2023.
        <Link href="/lincense">Licensing</Link></p>
        <p>
         <Link href="https://www.128.digital/webflow-templates">Webflow Templates </Link>   
         by 128.digital.Powered by Webflow</p>
      </div>
    </footer>
  )
}
